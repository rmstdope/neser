...
impl Ppu {
    ...
    const BOOT_LOGO_TILE_DATA: [u8; 200] = [
        ,
    ...
    /// Seed the decoded Nintendo logo tile data and tile map left by the boot ROM.
    pub(crate) fn seed_boot_logo(&mut self) {
        for (index, value) in Self::BOOT_LOGO_TILE_DATA.iter().copied().enumerate() {
            self.vram[Self::BOOT_LOGO_TILE_DATA_ADDR + index * 2] = value;
        }
