...
/// Full CGB boot ROM with animation and sound.
///
...
pub const CGB_BOOT_ROM: [u8; 2048] = [
    0x31, 0xFE, 0xFF, 0x21, 0x00, 0x80, 0xAF, 0x22, 0xCB, 0x6C, 0x28, 0xFA, 0x26, 0xFE, 0x0E,
    0xA0, // $0000
    0x22, 0x0D, 0x20, 0xFC, 0x0E, 0x10, 0x21, 0x30, 0xFF, 0x22, 0x2F, 0x0D, 0x20, 0xFB, 0xAF,
    0xE0, // $0010
    0x80, 0xE0, 0x81, 0x3E, 0x80, 0xE0, 0x26, 0xE0, 0x11, 0x3E, 0xF3, 0xE0, 0x12, 0xE0, 0x25,
    0x3E, // $0020
    0x77, 0xE0, 0x24, 0x3E, 0xFC, 0xE0, 0x47, 0x11, 0x04, 0x01, 0x21, 0x10, 0x80, 0x1A, 0x47,
    0xCD, // $0030
    0x00, 0x02, 0x13, 0x7B, 0xFE, 0x34, 0x20, 0xF5, 0x3E, 0x80, 0xE0, 0x68, 0x0E, 0x40, 0x21,
    0x80, // $0040
    0x02, 0x2A, 0xE0, 0x69, 0x0D, 0x20, 0xFA, 0x3E, 0x91, 0xE0, 0x40, 0x06, 0x3C, 0xCD, 0x40,
    0x02, // $0050
    0x05, 0x20, 0xFA, 0x3E, 0x83, 0xE0, 0x13, 0x3E, 0x87, 0xE0, 0x14, 0x06, 0x05, 0xCD, 0x40,
    0x02, // $0060
    0x05, 0x20, 0xFA, 0x3E, 0xC1, 0xE0, 0x13, 0x3E, 0x87, 0xE0, 0x14, 0x06, 0x1E, 0xCD, 0x40,
    0x02, // $0070
    // ── $0073: DMG compatibility mode detection ────────────────────────────────
    // Read CGB flag from cartridge header at $0143, test bit 7.
    // Bit 7 set → CGB-compatible: write CGB flag to KEY0 ($FF4C), OPRI stays $00.
    // Bit 7 clear → DMG-only: write $04 to KEY0, $01 to OPRI ($FF6C).
    0x05, 0x20, 0xFA, // DEC B; JR NZ, -6 (end of sound loop)
    0xFA, 0x43, 0x01, // LD A, [$0143] - read CGB flag
    0xCB, 0x7F, // BIT 7, A - test bit 7
    0x20, 0x0C, // JR NZ, +12 (→ $0086 .cgb_mode)
    // .dmg_mode:
    0x3E, 0x04, // LD A, $04
    0xE0, 0x4C, // LDH [$4C], A - KEY0 = $04 (DMG compat mode)
    0x3E, // $0080
    0x01, // LD A, $01
    0xE0, 0x6C, // LDH [$6C], A - OPRI = $01 (DMG OBJ priority)
    0x18, 0x07, // JR +7 (→ $008B .setup_regs)
    0x00, 0x00, // (padding)
    // .cgb_mode:
    0xFA, 0x43, 0x01, // LD A, [$0143] - re-read CGB flag
    0xE0, 0x4C, // LDH [$4C], A - KEY0 = CGB flag
    // .setup_regs:
    0x26, 0x11, // LD H, $11
    0x2E, 0x80, 0xE5, // $0090
    0xF1, // POP AF (A=$11, F=$80)
    0x01, 0x00, 0x00, // LD BC, $0000
    0x11, 0x08, 0x00, // LD DE, $0008
    0x21, 0x7C, 0x00, // LD HL, $007C
    0xC3, 0xFE, 0x00, // JP $00FE
    0x00, 0x00, 0x00, // $00A0
    ...
    0x50, // $00F0
    0xCD, 0x03, 0x02, 0x3E, 0x04, 0x0E, 0x00, 0xCB, 0x20, 0xF5, 0xCB, 0x11, 0xF1, 0xCB, 0x11,
    0x3D, // $0200
    0x20, 0xF5, 0x79, 0x22, 0x23, 0x22, 0x23, 0xC9, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, // $0210
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, // $0220
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, // $0230
    0xE5, 0x21, 0x0F, 0xFF, 0xCB, 0x86, 0xCB, 0x46, 0x28, 0xFC, 0xE1, 0xC9, 0x00, 0x00, 0x00,
    0x00, // $0240
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, // $0250
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, // $0270
    0xFF, 0x7F, 0x94, 0x52, 0x4A, 0x29, 0x00, 0x00, 0xFF, 0x7F, 0x94, 0x52, 0x4A, 0x29, 0x00,
    0x00, // $0280
    0xFF, 0x7F, 0x94, 0x52, 0x4A, 0x29, 0x00, 0x00, 0xFF, 0x7F, 0x94, 0x52, 0x4A, 0x29, 0x00,
    0x00, // $0290
    0xFF, 0x7F, 0x94, 0x52, 0x4A, 0x29, 0x00, 0x00, 0xFF, 0x7F, 0x94, 0x52, 0x4A, 0x29, 0x00,
...
/// CGB boot ROM for CGB-0 (first hardware revision).
///
...
///
/// All other aspects are identical to the Production CGB boot ROM, including
...
pub const CGB0_BOOT_ROM: [u8; 2048] = [
    0x31, 0xFE, 0xFF, 0x21, 0x00, 0x80, 0xAF, 0x22, 0xCB, 0x6C, 0x28, 0xFA, 0x26, 0xFE, 0x0E,
    0xA0, // $0000
    0x22, 0x0D, 0x20, 0xFC, 0xAF, 0xE0, 0x80, 0xE0, 0x81, 0x3E, 0x80, 0xE0, 0x26, 0xE0, 0x11,
    0x3E, // $0010
    0xF3, 0xE0, 0x12, 0xE0, 0x25, 0x3E, 0x77, 0xE0, 0x24, 0x3E, 0xFC, 0xE0, 0x47, 0x11, 0x04,
    0x01, // $0020
    0x21, 0x10, 0x80, 0x1A, 0x47, 0xCD, 0x00, 0x02, 0x13, 0x7B, 0xFE, 0x34, 0x20, 0xF5, 0x3E,
    0x80, // $0030
    0xE0, 0x68, 0x0E, 0x40, 0x21, 0x80, 0x02, 0x2A, 0xE0, 0x69, 0x0D, 0x20, 0xFA, 0x3E, 0x91,
    0xE0, // $0040
    0x40, 0x06, 0x3C, 0xCD, 0x40, 0x02, 0x05, 0x20, 0xFA, 0x3E, 0x83, 0xE0, 0x13, 0x3E, 0x87,
    0xE0, // $0050
    0x14, 0x06, 0x05, 0xCD, 0x40, 0x02, 0x05, 0x20, 0xFA, 0x3E, 0xC1, 0xE0, 0x13, 0x3E, 0x87,
    0xE0, // $0060
    // ── $0069: DMG compatibility mode detection (CGB-0) ────────────────────────
    // Same logic as Production CGB, just at different offset due to no wave RAM init.
    0x14, 0x06, 0x1E, 0xCD, 0x40, 0x02, 0x05, 0x20, 0xFA, // sound loop end
    0xFA, 0x43, 0x01, // LD A, [$0143] - read CGB flag
    0xCB, 0x7F, // BIT 7, A - test bit 7
    0x20, // $0070
    0x0C, // JR NZ, +12 (→ $007C .cgb_mode)
    // .dmg_mode:
    0x3E, 0x04, // LD A, $04
    0xE0, 0x4C, // LDH [$4C], A - KEY0 = $04 (DMG compat mode)
    0x3E, 0x01, // LD A, $01
    0xE0, 0x6C, // LDH [$6C], A - OPRI = $01 (DMG OBJ priority)
    0x18, 0x07, // JR +7 (→ $0081 .setup_regs)
    0x00, 0x00, // (padding)
    // .cgb_mode:
    0xFA, 0x43, 0x01, // LD A, [$0143] - re-read CGB flag
    0xE0, // $0080
    0x4C, // LDH [$4C], A - KEY0 = CGB flag
    // .setup_regs:
    0x26, 0x11, // LD H, $11
    0x2E, 0x80, // LD L, $80
    0xE5, // PUSH HL
    ...
    0xC3, // $0090
    0xFE, 0x00, // JP $00FE
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // $00A0
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, // $00B0
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, // $00C0
