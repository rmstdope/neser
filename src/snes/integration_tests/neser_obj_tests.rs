...
mod tests {
    ...
    /// glyphs read `30/31` above `20/21`. The remaining 40-pixel diff against a fresh
    /// Mesen2 capture is entirely inside that band (x 192-207, lines 0-15) with zero pixels
    /// outside it, and the structural test above pins the semantics independently of this
    /// CRC.
