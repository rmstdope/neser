...
DEST_DIR="$ROOT_DIR/roms/snes/automated_tests/processor_tests/65816/full/v1"
UPSTREAM_API="https://api.github.com/repos/SingleStepTests/ProcessorTests/contents/65816/v1"
UPSTREAM_RAW="https://raw.githubusercontent.com/SingleStepTests/ProcessorTests/main/65816/v1"

mkdir -p "$DEST_DIR"

echo "Refreshing full 65816 vector corpus into local cache $DEST_DIR"
