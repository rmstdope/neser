...
Super FX GSU-1 and GSU-2 (Star Fox, Stunt Race FX, Vortex, Yoshi's Island, Doom, Winter Gold)
are emulated. Cartridges with any other enhancement chip load, but show a warning that the
