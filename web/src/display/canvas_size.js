 ...
 */
export function computeWindowedCanvasSize(preferredHeight, nesAspectRatio, dpr) {
 ...
 * @returns {{ cssWidth: string, cssHeight: string, pixelWidth: number, pixelHeight: number }}
 */
export function computeFullscreenCanvasSize(availableWidth, availableHeight, nesAspectRatio, dpr) {
