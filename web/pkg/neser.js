...
export class WasmNes {
    ...
    load_rom(rom) {
        ...
        const ret = wasm.wasmnes_load_rom(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
     ...
     */
    render_frame() {
        const ret = wasm.wasmnes_render_frame(this.__wbg_ptr);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('neser_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
