DEF RESULTS_N_ROWS EQU 18 ; Max available
DEF NB_RUNS EQU RESULTS_N_ROWS / 2 ; Only half a run can be displayed per row
DEF NB_NOPS EQU NB_RUNS - 1
...
DEF CH3_FREQ EQU 2047 ; CH3 ticks every 1 MHz
