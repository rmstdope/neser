DEF RESULTS_START EQU $c000
DEF RESULTS_N_ROWS EQU 1
...
DEF TEST0_STAT EQU STATF_MODE00
DEF TEST1_STAT EQU STATF_MODE01
DEF TEST2_STAT EQU STATF_MODE10
DEF TEST3_STAT EQU STATF_MODE10
