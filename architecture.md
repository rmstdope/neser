...
| `src/snes/integration_tests/peterlemon_ppu_advanced_tests.rs` | PeterLemon advanced PPU mode suite (#2881): Mode 7 rotozoom (static + scripted rotate/zoom), HDMA Perspective and StarWars crawl, mosaic modes 3/5, six hires/interlace demos, four pseudo-hires HiColor demos. 10 Mesen2-approved goldens (the four pseudo-hires HiColor vectors joined with #3016); 11 vectors `#[ignore]`d pending #3017/#3020/#3021. |
