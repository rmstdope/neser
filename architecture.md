...
| `src/snes/integration_tests/jonasquinn_dma_tests.rs` | Canonical jonasquinn DMA/HDMA ROMs (#2884): `test_mdrhdma`, `hdma_midframe`, `test_dmavalid` (#3111), and `test_hdmadisable` (#3116) carry 0-pixel-diff Mesen2 goldens; `test_dmatiming_matches_mesen2`/`test_dmatiming_latches_hv_after_gpdma` are `#[ignore]`d divergences (#3127), and the `test_hdmasync`/`test_hdmatiming` byuu mirrors pass (#3062, #3120). |
