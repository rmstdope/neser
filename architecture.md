...
| `src/snes/integration_tests/peterlemon_ppu_advanced_tests.rs` | PeterLemon advanced PPU mode suite (#2881): Mode 7 rotozoom (static + scripted rotate/zoom), HDMA Perspective and StarWars crawl, mosaic modes 3/5, six hires/interlace demos, four pseudo-hires HiColor demos. 6 Mesen2-approved goldens; 15 vectors `#[ignore]`d pending #3016/#3017/#3018/#3020/#3021. |
