...
| 86 | Jaleco JF-13 (Moero!! Pro Yakyuu) | 32 KB switchable at $8000–$FFFF via bits[5:4] of register | 8 KB switchable via bits[1:0] ∥ (bit[6]→bit[2]); up to 64 KB | Fixed from header | None | None | None | ✅ | Register at $6000–$6FFF; $7000–$7FFF is audio expansion (not emulated). No deltas. |
