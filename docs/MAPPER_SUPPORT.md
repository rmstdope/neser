...
| 93 | Sunsoft 74S161/32 (Fantasy Zone) | Fixed 32 KB at $8000–$FFFF | 8 KB switchable ROM via bits [6:4] | H / V switchable via bit 0 of register | None | None | None | ✅ | Register at $6000–$7FFF. Bits [6:4] select 8 KB CHR bank; bit 0 selects mirroring (0=H, 1=V). No PRG switching, no bus conflicts, no PRG-RAM. |
