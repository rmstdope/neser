...
This skill is used for developing high quality Rust code. It uses a Rust rules set divided into 14 different categories. The rules were created by leonardomso. 

## When to use

Use these rule sets when
